...
function UserNavbar({ sidebarOpen, setSidebarOpen, setActiveTab }) {
  ...
  // User details for the User Navbar
  const userName = "Jason Derulo";
  const userEmail = "name@venuebooking.com";
  const userRole = "User";
  const lastLogin = "2024-07-11 17:00 IST"; // Example data
  const memberSince = "2023-03-10"; // Example data
      ...
      content: (
        <>
          ...
          <p className="mt-4 text-sm text-gray-500">
            (In a real application, this would be a dedicated profile page for the user.)
          </p>
        </>
      ),
    });
  ...
  const handleAccountSettings = () => {
    setModalContent({
      ...
      content: (
        <>
          <p>Here you can update your password, change your display name, or manage your notification preferences.</p>
  ...
  const handleNotificationSettings = () => {
    setModalContent({
      ...
      content: (
        <>
          <p>Manage how you receive notifications for your bookings, updates, and platform announcements.</p>
          <ul className="list-disc list-inside mt-2 text-sm text-gray-600">
            ...
            <li>In-app Alerts: <span className="font-semibold">On</span></li>
            <li>Newsletter Subscription: <span className="font-semibold">On</span></li>
          </ul>
          <p className="mt-4 text-sm text-gray-500">
  ...
  const handleSignOut = () => {
    console.log("Signing out User and redirecting to /login/user...");
    // In a real app, you would perform actual logout logic
    window.location.href = '/login/user'; // Redirect to the User login page
    setShowProfileMenu(false);
  };
